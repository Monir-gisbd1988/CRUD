...
<head>
    ...
    <!-- Custom styles -->
    <link rel="stylesheet" href="http://localhost/CRUD/header/css/admin.css" />
    <style>
        .text-justify {
            text-align: justify;
        }
        ...
        .gradient-custom-2 {
            ...
            background: -webkit-linear-gradient(to right, #d8363a);

            /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
            background: linear-gradient(to right, #d8363a);
        }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand mt-2 mt-lg-0" href="<?php echo BASE_URL; ?>">
                    <img src="<?php echo BASE_URL; ?>/img/globe-2.png" alt="MDB Logo" width="40" height="40" loading="lazy" />
                </a>
                <!-- Left links -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                            <img src="/CRUD/img/403019_avatar_male_man_person_user_icon.png" class="rounded-circle" height="40 " alt=" Man" loading="lazy" />
                        </a>
